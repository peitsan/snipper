...
#include "dth11.h"
#include "stdio.h"
#define KEY1 PBin(11)//设置按键
#define KEY2 PBin(12)//温湿度+
#define KEY3 PBin(13)//温湿度-
#define motor1 PBout(10)//加湿电机
#define motor2 PBout(14)//散热风扇
...
{	 
	...
	while(1)
	{
		...
		if(temp>buf2) motor2=0;//温度大于设置值  开启散热
		else motor2=1;
		if(hum<buf3) motor1=0;//湿度过低  开启加湿
		else motor1=1;
		if(buf1==0)//显示设置状态
		{
